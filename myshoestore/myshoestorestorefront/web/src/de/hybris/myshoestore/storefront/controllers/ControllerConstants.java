...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String CustomBannerOffersComponent =  _Prefix + CustomBannerOffersComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Misc // NOSONAR
			{
                ...
                String MyEmployeeDetails = "pages/misc/myEmployeeDetails";
				String CreateEmployee = "pages/misc/create-employee";
				String UpdateEmployee = "pages/misc/update-employee";
				String UpdateEmployeeSalary = "pages/misc/update-employee-salary";
            }
			...
			interface Product // NOSONAR
			{
				...
				String cadburryDetails = "pages/product/cadburryDetails";
                String CreateCadburry = "pages/product/create-cadburry";

				String updateCadburry = "pages/product/updateCadburry";
				String myCadburry = "pages/product/myCadburry";
                String recipeDetails = "pages/product/recipeDetails";
                String ingrediantsDetails = "pages/product/recipeDetails";
            }
